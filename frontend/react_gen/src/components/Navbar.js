...
export default function Navbar(props) {
  ...
  zIndex: 1000,
      ...
      <div className="container-fluid">
        <a className="navbar-brand fw-bold" href="/" style={{ fontSize: '1.5rem', color: 'rgb(9, 116, 100)' }}>
          {props.title}
        </a>
        ...
        <div className="collapse navbar-collapse" id="navbarContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0" style={{ gap: '1rem' }}>
            <li className="nav-item">
              <a className="nav-link active" aria-current="page" href="/" style={{ color: 'rgb(9,116,100)' }}>
                Home
              </a>
            </li>
            <li className="nav-item">
              <a className="nav-link" href="/" style={{ color: 'rgb(9,116,100)'}}>
                Features
              </a>
            </li>
            <li className="nav-item">
